...
var logger = glog.NewWithOptions(os.Stdout, glog.Options{
	ReportTimestamp: true,
	TimeFormat:      time.DateTime,
	Prefix:          "SpectreLink",
})

var errlogger = glog.NewWithOptions(os.Stdout, glog.Options{
	ReportCaller:    true,
	ReportTimestamp: true,
	TimeFormat:      time.DateTime,
	Prefix:          "SpectreLink",
...
func init() {
	...
	errlogger.SetColorProfile(termenv.ANSI256)
...
func SetLevel(level glog.Level) {
